...
RSpec.describe Event, type: :model do
  ...
  let!(:house_party) {Event.new(group_id: aga.id, name: "Dodgeball Mayhem 2", category: "social")}
  ...
  it 'should be valid with a name and category' do
  ...
  it 'should know if it is assigned' do
    expect(clean_bathroom.assigned)
  end
